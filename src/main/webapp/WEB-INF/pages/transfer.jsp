...
<div class="Menu" id="floater">
    <div class="withdrawMenu" id="content">
        <form method="post" action="${pageContext.request.contextPath}/bank/transfer">
            <input type="text" id="user" name="username" placeholder="请输入您要转账的用户">
            <input type="text" id="balance" name="balance" placeholder="请输入您要转账的金额" onkeyup="(this.v=function(){this.value=this.value.replace(/[^0-9-]+/,'');}).call(this)" onblur="this.v();"/>
