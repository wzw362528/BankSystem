...
<div class="Menu" id="floater">
    <div class="withdrawMenu" id="content">
        <form method="post" action="${pageContext.request.contextPath}/bank/deposit">
            <input type="text" id="balance" name="balance" placeholder="请输入您要存入的金额" onkeyup="(this.v=function(){this.value=this.value.replace(/[^0-9-]+/,'');}).call(this)" onblur="this.v();">
