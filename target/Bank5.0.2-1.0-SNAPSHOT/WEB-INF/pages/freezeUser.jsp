...
<header class="container-fluid">
    ...
    <div class="row paddtop">
        ...
        <div class="col-md-8 welcome">
            <h1 style="color: #67b168" id="wel_title">管理员您辛苦了</h1>
        </div>
...
<div class="Menu" id="floater">
    <div class="withdrawMenu" id="content">
        <form method="post" action="${pageContext.request.contextPath}/bank/freezeUser">
            <input type="text" id="balance" name="username" placeholder="请输入您要操作的用户名">
